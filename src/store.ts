...
useStore.subscribe(
    (state, previousState) => {
        ...
        // Only send remaining targets to Unity when:
        // 1. Phase changed to a challenge phase (entering a new challenge)
        // 2. Index changed within the same challenge phase (progressing to next target)
